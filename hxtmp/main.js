...
NeatScene.__name__ = true;
NeatScene.prototype = {
	initCamera: function() {
		var camera = new THREE.PerspectiveCamera(70,this.width / this.height,1,10);
